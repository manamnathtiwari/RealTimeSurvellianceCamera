...
class EmotionDetector:
    def __init__(self):
        # Loading the model trained for doing Violence Detection
        self.emotion_model = load_model("C:/Users/Manamnath tiwari/OneDrive/Desktop/Mirage-Real Time Violence Detection/emotion_detection_model_50epochs.h5")
